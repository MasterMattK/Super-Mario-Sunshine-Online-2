...
def compile(inpath, outpath, mode, optimize="-O1", std="c99", warning="-w"):
    ...
    args = [GCCPATH, inpath, mode, "-o", outpath, optimize, warning, "-fno-asynchronous-unwind-tables"]
    print(args)
...
def read_map(mappath):
    ...
    with open(mappath, "r") as f:
        ...
        while next.strip() != "":
            ...
            # this was added by MasterMattK
            # this makes it so you can use multiple c files instead of just 1
            if vals[0] == ".text":
                next = f.readline()
                continue
